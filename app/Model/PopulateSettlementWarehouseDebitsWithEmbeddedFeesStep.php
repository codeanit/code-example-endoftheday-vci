...
/**
 * Fetch Query to update warehouse.workflow_eod's field 'populate_settlement_warehouse_debits_with_embedded_fees'
 */
class PopulateSettlementWarehouseDebitsWithEmbeddedFeesStep extends Step {
 ...
 */
	public function __construct($date) {
		...
		$this->_stepField = 'populate_settlement_warehouse_debits_with_embedded_fees';
		$this->_query = array();
 ...
 */
	public function executeInternal() {
		...
		$data= $this->SettlementWarehouseDebitsWithEmbeddedFee->
						getSettlementTransactionIds($this->__date,'debit');
		$this->_query = $this->SettlementWarehouseDebitsWithEmbeddedFee->
						createDebitsWithEmbeddedFeesQuery($data,$this->__date);
