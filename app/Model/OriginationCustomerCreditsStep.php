...
/**
 * Fetch Query to update warehouse.workflow_eod's field 'origination_customer_credits'
 */
class OriginationCustomerCreditsStep extends Step{
 ...
 */
	public function __construct($date) {
		...
		$this->_stepField = 'origination_customer_credits';
 ...
 */
	public function executeInternal() {
		...
		$this->_query = $this->Origination->originateCustomerCreditsForDay($this->__date);
