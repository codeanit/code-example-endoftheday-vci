...
/**
 * Fetch Query to update warehouse.workflow_eod's field 'csv_merchant_ach_transactions'
 */
class CSVMerchantAchTransactionsStep extends Step {
 ...
 */
	public function __construct($date) {
		...
		$this->_stepField = 'csv_merchant_ach_transactions';
		$this->_query = array();
 ...
 */
	public function executeInternal() {
		...
		$this->_query = $this->MerchantAchTransaction->createCSVTransactionsQuery(
						$this->__date);
