...
/**
 * Fetch Query to update warehouse.workflow_eod's field 'populate_settlement_warehouse_credits'
 */
class PopulateSettlementWarehouseCreditsStep extends Step {
 ...
 */
	public function __construct($date) {
		...
		$this->_stepField = 'populate_settlement_warehouse_credits';
		$this->_query = array();
 ...
 */
	public function executeInternal() {
		...
		$transIds= $this->SettlementWarehouseCredit->getSettlementTransactionIds(
						$this->__date);
		$this->_query = $this->SettlementWarehouseCredit->createCreditsQuery(
