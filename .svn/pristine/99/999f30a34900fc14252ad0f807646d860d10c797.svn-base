...
/**
 * Fetch Query to update warehouse.workflow_eod's field 'populate_settlement_warehouse_reversals'
 */
class PopulateSettlementWarehouseReversalsStep extends Step {
 ...
 */
	public function __construct($date) {
		...
		$this->_stepField = 'populate_settlement_warehouse_reversals';
		$this->_query = array();
 ...
 */
	public function executeInternal() {
		...
		$data= $this->SettlementWarehouseReversal->getSettlementTransactionIds(
						$this->__date,'credit');
		$this->_query = $this->SettlementWarehouseReversal->createReversalsQuery(
						$data,$this->__date);
